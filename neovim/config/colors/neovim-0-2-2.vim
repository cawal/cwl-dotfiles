...
highlight def link Substitute     Search
highlight def link QuickFixLine   Search
highlight def link Whitespace     NonText
highlight def link EndOfBuffer    NonText
highlight def link String         Constant
highlight def link Character      Constant
highlight def link Number         Constant
highlight def link Boolean        Constant
highlight def link Float          Number
highlight def link Function       Identifier
highlight def link Conditional    Statement
highlight def link Repeat         Statement
highlight def link Label          Statement
highlight def link Operator       Statement
highlight def link Keyword        Statement
highlight def link Exception      Statement
highlight def link Include        PreProc
highlight def link Define         PreProc
highlight def link Macro          PreProc
highlight def link PreCondit      PreProc
highlight def link StorageClass   Type
highlight def link Structure      Type
highlight def link Typedef        Type
highlight def link Tag            Special
highlight def link SpecialChar    Special
highlight def link Delimiter      Special
highlight def link SpecialComment Special
highlight def link Debug          Special
